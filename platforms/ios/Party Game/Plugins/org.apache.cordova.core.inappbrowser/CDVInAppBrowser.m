...
//    if ([[[request URL] absoluteString] rangeOfString:@"?close"].location != NSNotFound
//        && [[[request URL] absoluteString] rangeOfString:@"display=touch"].location == NSNotFound
//        && [[[request URL] absoluteString] rangeOfString:@"client_id"].location == NSNotFound
//        ) {
//        [self.inAppBrowserViewController fakeRequest:[request URL]];
//        return NO;
//    }
